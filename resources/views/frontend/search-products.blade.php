                ...
                <div class="col-md-10" data-aos="fade-up" data-aos-delay="400">
                    ...
                    <div class="row justify-content-center mt-5">
                        <div class="col-md-8 text-center">
                            <h1>{{$searchvalues["town"]}}</h1>
                            <p class="mb-0">{{$searchvalues["category"]}}</p>
                            @if($products->count()==0)
                                <h3 style="color: white">Aramana Uygun Sonuç Bulunamadı</h3>
                            @endif
                        </div>
                    </div>
                            ...
                            <div class="col-lg-4">
                                ...
                                <div class="d-block d-md-flex listing vertical">
                                    ...
                                    <div class="lh-content">
                                        ...
                                        <address>{{$product->getTown->town_name}}
                                            , {{$product->getTown->getCity->city_name}}</address>
                                        <p class="mb-0">
