...
<section class="body">
    ...
    <header class="header">
        <div class="logo-container">
            <a href="../" class="logo">
                <img src="{{asset('backend/')}}/assets/images/tp-logo.png" height="35" alt="Porto Admin" />
            </a>
            ...
            <div id="userbox" class="userbox">
                <a href="#" data-toggle="dropdown">
                    <figure class="profile-picture">
                        <img src="{{asset('backend/')}}/assets/images/!logged-user.jpg" alt="Joseph Doe" class="img-circle" data-lock-picture="assets/images/!logged-user.jpg" />
                    </figure>
